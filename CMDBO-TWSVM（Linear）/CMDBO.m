...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [fMin , bestX, Convergence_curve ] = CMDBO(data_train,Y_train,pop, M,c,d,dim,fobj,ker  )
...
%Initialization
for i = 1 : pop
    x( i, : ) = lb + y_4(i)*(ub - lb) .* rand( 1, dim );  
    fit( i ) = fitness(data_train,Y_train, x( i, 1 ),x(i,2),x(i,3) ,ker);                     
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
  ...
  for j = 20 : pop                 % Equation (7)
      ...
      fit(j ) = fitness(data_train,Y_train, x( i, 1 ),x(i,2),x(i,3),ker ) ;
  end
