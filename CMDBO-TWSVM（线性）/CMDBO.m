...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [fMin , bestX, Convergence_curve ] = CMDBO(data_train,Y_train,pop, M,c,d,dim,fobj  )
...
for i = 1 : pop
    ...
    fit( i ) = fitness(data_train,Y_train, x( i, 1 ),x(i,2));                     
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
  ...
  for j = 20 : pop                 % Equation (7)
      ...
      fit(j ) = fitness(data_train,Y_train, x( i, 1 ),x(i,2) ) ;
  end
