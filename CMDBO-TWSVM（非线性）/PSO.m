function [fmin,xbest,Convergence_curve]=PSO(data_train,Y_train,SearchAgents_no,Max_iteration,lb,ub,dim,fobj,ker)
E=0.000001;
...
for i=1:particlesize
	f(i)=fitness(data_train,Y_train,x(i,1),x(i,2),x(i,3),ker);	
end
personalbest_x=x;
...
%     disp('迭代次数为：');
    Convergence_curve(k)=1-globalbest_faval;
